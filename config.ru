...
require_relative 'lib/controllers/direct_messages_controller'
...
map '/direct_messages' do
  direct_messages_controller = TweetCamp::DirectMessagesController
  direct_messages_controller.set :twitter, twitter

  run direct_messages_controller.new
end
